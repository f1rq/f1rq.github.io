<script lang="ts">
  ...
  <div
    ...
    class={cn(
      "group relative flex size-full overflow-hidden rounded-xl bg-neutral-100 dark:bg-base-100 border text-black dark:text-white justify-center py-4",
      className
    )}
  >
    <div class="relative z-10 w-[90px]">
      <!-- Default  -->
      <slot>
